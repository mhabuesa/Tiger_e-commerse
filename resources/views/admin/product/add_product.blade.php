    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{route('product.list')}}" class="btn btn-primary  "> <i data-feather="list"></i> Product
                    List</a>
            </div>
            <div class="card-body">
                @if (session('success'))
                    ...
                    <div class="row">
                                ...
                                <input type="number" name="discount" class="form-control">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="input-tags" name="tags[]" class="">
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="short_desp" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
