    ...
    <div class="container container-fluid-sm">
        <div class="hero-slider">
            ...
            <div class="hero-slider-item">
                <div class="slider-bg">
                    <img height="600" width="931" src="{{asset('uploads/banner')}}/{{$banner->banner_image}}" alt="">
                </div>
    ...
    <div class="container">
        ...
        <div class="featured-categorie-slider owl-carousel">
            ...
            <div class="featured-item">
                <div class="images">
                    <img class="m-auto" style="width: 50px;" src="{{asset('uploads')}}/category/{{$category->icon}}" alt="">
                </div>
                <div class="text">
                    <h2>
                        @if (strlen($category->category_name) > 13)

                        <a href="">{{substr($category->category_name, 0,13).'...'}}</a>
                        @else
            ...
            <div class="col-lg-6 col-md-12">
                <div class="offer-wrap" style="background: url({{asset('uploads/offer')}}/{{$offer->first()->image}});">
                    <div class="content">
                        ...
                        <span class="offer-price">&#2547;{{$offer->first()->after_discount}}</span>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product-item">
                        <div class="image">
                            <img height="190" src="{{asset('uploads/product/preview')}}/{{$product->preview}}" alt="">
                            @if ($product->discount)
                        ...
                        <div class="text">
                            <h2 title="{{$product->product_name}}"><a href="{{route('single.product', $product->slug)}}">
                                @if (strlen($product->product_name) > 23)
                                {{substr($product->product_name, 0,23).'...'}}
                                @else
    ...
    <div class="container">
        <div class="upcoming-offer">
            ...
            <div class="right-image">
                <img src="{{asset('uploads/offer')}}/{{$bigoffer->first()->image}}" alt="">
            </div>
            <div class="section-title-text">
                <h2>{{$bigoffer->first()->title}}</h2>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text">
                        <div class="shape-text">{{$bigoffer->first()->shape1}} <div class="shape-single">
                                <div class="shape">
                                ...
                                {{$bigoffer->first()->percentage}}
                            </div> {{$bigoffer->first()->shape2}}</div>
            ...
            <div class="col-lg-6 col-12">
                <ul class="special-product">
                    <li>
                        <div class="product-item">
                            <div class="image">
                                <img style="width: 331px; height:325px;" src="{{asset('uploads')}}/product/preview/{{$product->preview}}" alt="">
                            </div>
                            <div class="text">
...
<section class="themart-trendingproduct-section section-padding">
    <div class="container">
        ...
        <div class="trendin-slider owl-carousel">
            ...
            <div class="product-item">
                <div class="image">
                    <img style="width: 284px; height:189px;" src="{{asset('Uploads')}}/product/preview/{{$product->preview}}" alt="">
                    @if ($product->discount != '')

                    <div class="tag new">{{$product->discount}} %</div>
                    @endif
                </div>
                <div class="text">
                    <h2><a href="product-single.html">{{$product->product_name}}</a></h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-wrap">
                    ...
                    <div class="product-card">
                        <div class="card-image">
                            <div class="image">
                                <img style="width: 144px; height:96px" src="{{asset('uploads')}}/product/preview/{{$product->preview}}" alt="">
                            </div>
                        </div>
                        <div class="content">
